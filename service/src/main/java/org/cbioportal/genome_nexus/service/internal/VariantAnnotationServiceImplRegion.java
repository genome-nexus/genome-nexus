...
@Service(value="VariantAnnotationServiceImplRegion")
public class VariantAnnotationServiceImplRegion extends BaseVariantAnnotationServiceImpl
{
    private static final Log LOG = LogFactory.getLog(VariantAnnotationServiceImplDbsnp.class);

    @Autowired
    public VariantAnnotationServiceImplRegion(CachedVariantRegionAnnotationFetcher cachedVariantRegionAnnotationFetcher,
