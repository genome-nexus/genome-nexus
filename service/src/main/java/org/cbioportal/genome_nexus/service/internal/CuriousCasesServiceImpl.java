...
public class CuriousCasesServiceImpl implements CuriousCasesService {
    ...
    private CuriousCases generateCuriousCases(VariantAnnotation annotation, String genomicLocation) {
        ...
        if (annotation != null) {
            ...
            // VariantType variantType = GenomicLocationUtil.getTypeFromGenomicLocation(genomicLocation);
            // TODO: We don't use this endpoint anymore. The reVUE data is read from revue-data.json
            // Need to clean up this code
            VariantType variantType = null;

            // Potential KIT Exon 11 inframe deletion
            if (chr.equals("4") && start <= 55593580 && end >= 55593606 && variantType.equals(VariantType.DELETION)) {
            ...
            // Potential KIT Exon 11 inframe deletion
            else if (chr.equals("4") && start == 55593580 && end == 55593580 && variantType.equals(VariantType.SUBSTITUTION) && ref.equals("A") && var.equals("T")) {
                comment = "Potential in-frame deletion event at intron10-exon 11 boundary, commmon in Gastrointestinal Stromal Tumors";
                pubmedIds = new ArrayList<>(Arrays.asList(15507676, 27600498, 32697050));
            }
            // Potential APC Exon 9 intro of cryptic splice acceptor site
            else if (chr.equals("5") && start == 112151184 && end == 112151184 && variantType.equals(VariantType.SUBSTITUTION) && ref.equals("A") && var.equals("G")) {
            ...
            else if (chr.equals("3") && start <= 41266015 && end >= 41266016 && variantType.equals(VariantType.DELETION)) {
                comment = "Potential Exon Skip Event common in Colorectal Cancers";
                pubmedIds = new ArrayList<>(Arrays.asList(29316426));
            }
            // Potential CTNNB1 Exon 3 inframe deletion
            else if (chr.equals("3") && start <= 41266245 && end >= 41266246 && variantType.equals(VariantType.DELETION)) {
                comment = "Potential Exon Skip Event common in Colorectal Cancers";
                pubmedIds = new ArrayList<>(Arrays.asList(29316426));
            }
            // Potential MET Exon 14 inframe deletion
            else if (chr.equals("7") && variantType.equals(VariantType.SUBSTITUTION) && (start == 116411901 && end == 116411901 ||
            ...
            // Potential MET Exon 14 inframe deletion
            else if (chr.equals("7") && start <= 116411901 && end >= 116411902 && variantType.equals(VariantType.DELETION)) {
                comment = "Potential Exon Skip Event common in Non-small Cell Lung Cancer";
            }
            // Potential MET Exon 14 inframe deletion
            else if (chr.equals("7") && start <= 116412044 && end >= 116412045 && variantType.equals(VariantType.DELETION)) {
                comment = "Potential Exon Skip Event common in Non-small Cell Lung Cancer";
            }
            // Potential PIK3R1 Exon 14 inframe deletions
            else if (chr.equals("5") && start == 67591246 && end == 67591246 && variantType.equals(VariantType.SUBSTITUTION) && ref.equals("A") && var.equals("T")) {
                comment = "Potential PIK3R1 Exon 14 inframe deletion";
            }
            // Potential PIK3R1 Exon 14 inframe deletions
            else if (chr.equals("5") && start <= 67591231 && end >= 67591258 && variantType.equals(VariantType.DELETION)) {
                comment = "Potential PIK3R1 Exon 14 inframe deletion";
            }
            // Potential PIK3R1 Exon 14 inframe deletions
            else if (chr.equals("5") && start <= 67591153 && end >= 67591154 && variantType.equals(VariantType.DELETION)) {
                comment = "Likely not a PIK3R1 Exon 14 inframe deletion";
            }
            // Potential PIK3R1 Exon 14 inframe deletions
            else if (chr.equals("5") && start == 67591153 && end == 67591154 && variantType.equals(VariantType.INDEL) && ref.equals("GT") && var.equals("C")) {
                comment = "Likely not a PIK3R1 Exon 14 inframe deletion";
            }
            // Potential PIK3R1 Exon 11 inframe deletions
            else if (chr.equals("5") && start == 68293836 && end == 68293836 && variantType.equals(VariantType.SUBSTITUTION) && ref.equals("T") && var.equals("G")) {
                comment = "Potential PIK3R1 Exon 11 inframe deletion";
            }
            // Potential PIK3R1 Exon 11 inframe deletions
            else if (chr.equals("5") && start == 68293835 && end == 68293835 && variantType.equals(VariantType.SUBSTITUTION) && ref.equals("G") && var.equals("A")) {
                comment = "Potential PIK3R1 Exon 11 inframe deletion";
            }
