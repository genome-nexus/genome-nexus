...
@Service(value="VariantAnnotationServiceImplHgvs")
public class VariantAnnotationServiceImplHgvs extends BaseVariantAnnotationServiceImpl
{
    ...
    @Autowired
    public VariantAnnotationServiceImplHgvs(CachedVariantAnnotationFetcher cachedVariantAnnotationFetcher,
