...
@Service(value="VariantAnnotationServiceImplDbsnp")
public class VariantAnnotationServiceImplDbsnp extends BaseVariantAnnotationServiceImpl
{
    private static final Log LOG = LogFactory.getLog(VariantAnnotationServiceImplDbsnp.class);

    @Autowired
    public VariantAnnotationServiceImplDbsnp(CachedVariantIdAnnotationFetcher cachedVariantIdAnnotationFetcher,
