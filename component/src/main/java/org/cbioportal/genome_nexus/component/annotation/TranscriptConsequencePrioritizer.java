...
public class TranscriptConsequencePrioritizer
{
    ...
    private static Map<String, Integer> initEffectPriority()
    {
        ...
        effectPriority.put("transcript_amplification", 7); // A feature amplification of a region containing a transcript (high severity on Ensembl)
        ...
        effectPriority.put("feature_elongation", 18); // A sequence variant that causes the extension of a genomic feature, with regard to the reference sequence (high severity on Ensembl)
        effectPriority.put("feature_truncation", 18); // A sequence variant that causes the reduction of a genomic feature, with regard to the reference sequence (high severity on Ensembl)
