...
public class MutationAssessorTest
{
    ...
    */
    ...
    public void testVariants() throws IOException {
        ...
        assertEquals(mutationObj1.getFunctionalImpactScore(), mutationObj2.getFunctionalImpactScore());
        ...
        assertEquals(mutationObj21.getFunctionalImpactScore(), mutationObj22.getFunctionalImpactScore());
        ...
        assertEquals(mutationObj31.getFunctionalImpactScore(), mutationObj32.getFunctionalImpactScore());
